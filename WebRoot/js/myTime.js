...
//使用时主调方法如下：可以有多种显示形式如下示例；还可以自己编辑显示样式：
//<input  onclick="SelectDate(this,'yyyy 年')" <br />  
//<input  onclick="SelectDate(this,'yyyy 年 MM 月')"  /><br />  
//<input  onclick="SelectDate(this,'yyyy"/MM"/dd')"  /><br />  
//<input  onclick="SelectDate(this,'yyyy-MM-dd hh时')"  /><br />  
//<input  onclick="SelectDate(this,'yyyy-MM-dd hh:mm')"  /><br />   
//<input  onclick="SelectDate(this,'yyyy年MM月dd日 hh时mm分ss秒',0,-150)" /><br />  
//<input  onclick="SelectDate(this,'yyyy-MM-dd hh:mm:ss',0,-150)" /><br /> 
